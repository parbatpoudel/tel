...
public class  Solution_of_statistics extends AppCompatActivity {

    ListView listtttt;
    // add all the title and description and image on assending order
    String titlesssss[] = {"   Solution of 2019", "   Solution of 2018", "   Solution of  2017", "   Solution of 2016", "      Solution of 2018"};
    String descriptionsssss[] = {"   ", "   ", "   ", "   ", "   "};
    int imgsssss[] = {R.drawable.formula, R.drawable.finance, R.drawable.informationsystem, R.drawable.businesscommunication, R.drawable.finance};


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_solution_of_statistics);

        getSupportActionBar().setTitle("Solution of Statistics");
        ...
        listtttt.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    Toast.makeText(Solution_of_statistics.this, "   Solution of 2019", Toast.LENGTH_SHORT).show();
                }
                if (position==1){


                    Toast.makeText(Solution_of_statistics.this, "   Solution of 2018", Toast.LENGTH_SHORT).show();
                }
                if (position==2){

                    Toast.makeText(Solution_of_statistics.this, "   Solution of 2017", Toast.LENGTH_SHORT).show();
                }
                if (position==3){

                    Toast.makeText(Solution_of_statistics.this, "   Solution of 2016", Toast.LENGTH_SHORT).show();
                }
                if (position==4){

                    Toast.makeText(Solution_of_statistics.this, "   Solution of 2015", Toast.LENGTH_SHORT).show();
                }
