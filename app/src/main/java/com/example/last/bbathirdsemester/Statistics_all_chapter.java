...
public class Statistics_all_chapter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_all_chapter);

        getSupportActionBar().setTitle("Business Statistics");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        listtttt = findViewById(R.id.listtttt1);
        runAnimation(listtttt,0);


        //creating instance of class Adapter

        MyAdapter adapterrrrr = new MyAdapter(this, titlesssss, imgsssss, descriptionsssss);

        //set adapter to list
        listtttt.setAdapter(adapterrrrr);
        ...
        listtttt.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    Toast.makeText(Statistics_all_chapter.this, "Chapter One Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==1){


                    Toast.makeText(Statistics_all_chapter.this, "Chapter Two Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==2){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Three Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==3){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Four Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==4){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Five Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==5){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Six Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==6){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Seven Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==7){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Eight Clicked... ", Toast.LENGTH_SHORT).show();
                }
                if (position==8){

                    Toast.makeText(Statistics_all_chapter.this, "Chapter Nine Clicked... ", Toast.LENGTH_SHORT).show();
                }
